...
const JOBS = [
  {
    ...
    color: '#89b4fa',
    highlights: [
      'Architected end-to-end RLHF pipeline for text-to-SQL with custom reward modeling; implemented policy optimization with KL-divergence monitoring and gradient debugging',
      'Optimized transformer inference with quantization (4-bit/8-bit) reducing latency 60% while maintaining F1 above 0.95; engineered streaming NLP platforms processing 10K+ daily transactions',
      'Built retrieval-augmented systems integrating semantic search with vector databases for context-aware query processing',
    ],
    stack: ['RLHF', 'Transformers', 'RAG', 'Quantization', 'Vector DBs', 'Python'],
  },
  {
    title: 'ML Engineer',
    ...
    color: '#cba6f7',
    highlights: [
      'Designed and trained hybrid LSTM-MeshNet from scratch achieving 30% positioning accuracy improvement; implemented custom optimization addressing vanishing gradients and convergence dynamics',
      'Led end-to-end fine-tuning of GANs reducing post-production time 40%; debugged mode collapse through architectural modifications and learning rate scheduling',
      'Established reproducible training infrastructure with experiment tracking (W&B), version control, and CI/CD; managed 3-engineer team',
    ],
    stack: ['LSTM', 'GANs', 'PyTorch', 'MLOps', 'W&B', 'CI/CD'],
  },
  {
    ...
    color: '#a6e3a1',
    highlights: [
      'Designed and trained transformer-based post-OCR correction models achieving 15% accuracy gains; implemented attention mechanism analysis for complex layout understanding',
      'Co-developed patent-pending approach combining vision transformers with geometric reasoning for document layout analysis',
      'Published research on code-mixed NER at IEEE ICETITE 2024',
    ],
    stack: ['Transformers', 'OCR', 'Document AI', 'Vision Transformers', 'BERT', 'Python'],
  },
]
